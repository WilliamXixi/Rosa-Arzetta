...
const isAntiLink = isGroup ? antilink.includes(from) : false
        ...
        return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%.+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%+.~#?&/=]*)/, 'gi'))
         ...
         const reply = (teks) => {
            ...
            hexa.sendMessage(from, teks, text, { quoted: mek, thumbnail: fs.readFileSync('./stik/fake.jpeg'), contextInfo: { externalAdReply: { title: 'Will Ft Rosa', body: 'ChipHiggsDomino', sourceUrl: `https://wa.me/c/6282289662946`, thumbnail: fs.readFileSync('./stik/thumb.jpeg') }}})
...
case 'button':
	...
	break
	case 'autovn':
if (!mek.key.fromMe) return reply('Khusus Admin')
...
break 
case 'haram':
axios.get(`https://www.nekos.life/api/v2/img/hentai`).then(v => udin.sendMessage(from, { url: v.data.url }, 'imageMessage', { quoted: qul, thumbnail: Buffer.alloc(0) }))
break
case 'image':
listnya = `Contoh Dan List\n\n #image yuri\n\nsolog\nsmug\nfeet\nsmallboobs\nlewdkemo\nwoof\ngasm\nsolo\n8ball\ngoose\ncuddle\navatar\ncum\nslap\nles\nv3\nerokemo\nbj\npwankg\nnekoapi_v3.1\nero\nhololewd\npat\ngecg\nholo\npoke\nfeed\nfox_girl\ntits\nnsfw_neko_gif\neroyuri\nholoero\npussy\nRandom_hentai_gif\nlizard\nyuri\nketa\nneko\nhentai\nfeetg\neron\nerok\nbaka\nkemonomimi\nhug\ncum_jpg\nnsfw_avatar\nerofeet\nmeow\nkiss\nwallpaper\ntickle\nblowjob\nspank\nkuni\nclassic\nwaifu\nfemdom\nboobs\ntrap\nlewd\npussy_jpg\nanal\nfutanari\nngif\nlewdk`
if (!q) return reply(listnya)
axios.get(`https://www.nekos.life/api/v2/img/${q}`).then(v => udin.sendMessage(from, { url: v.data.url }, 'imageMessage', { quoted: qul, thumbnail: Buffer.alloc(0) }))
break
case 'listharga':
...
hexa.sendMessage(from, foto, image, {quoted : ftroli, thumbnail: thu, caption: `${help123}`, contextInfo: {mentionedJid: [sender], forwardingScore: 250, isForwarded: true,  externalAdReply: { title: 'Will Ft Rosa', body: 'ChipDomino', sourceUrl: `https://wa.me/c/6282289662946`, thumbnail: fakebis }}}) 
break
case 'tt':
