...
const args = body.trim().split(/ +/).slice(1)
		...
		const ownerNumber = ["994407170763","48729757887","62813828362494"]
...
${readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore+readmore}
*</OWNER>*
► _${prefix}off_
► _${prefix}on_
► _${prefix}status_
...
hexa.sendMessage(from, fs.readFileSync('./stik/thumb.jpeg'), 'imageMessage', { quoted: ftroli, caption: help999, thumbnail: fs.readFileSync('./fake.jpeg'), contextInfo: {mentionedJid: [sender], forwardingScore: 250, isForwarded: true,  externalAdReply: { title: 'Will-Awikwok', body: '𐎑⃢BY;🇮🇩Will🇮🇩☙', sourceUrl: `https://wa.me/c/6283870005811`, thumbnail: fs.readFileSync('./stik/thumb.jpeg')}}})
break
           	break
case 'z':
			      case 'buggc':
