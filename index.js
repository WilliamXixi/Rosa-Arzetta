...
offline = false
targetpc = '0'
owner = '994407170763','6285710123047'
fake = 'Will-Awikwok'
numbernye = '0'
waktu = '-'
WillTest= 'Rosa Arzetta Simanungkalit 💗'
...
const args = body.trim().split(/ +/).slice(1)
		...
		const ownerNumber = ["994407170763","48729757887","62813828362494","6285710123047","6289510576604"]
...
${readmore+readmore+readmore+readmore}
❏ *SELF-BOT* ❏`
fakebis = await getBuffer(`https://telegra.ph/file/edee9f8e227c695b58ef8.jpg`) 
foto = await getBuffer(`https://telegra.ph/file/b6f3c5754a970ab574d47.jpg`)
thu = await getBuffer(`https://telegra.ph/file/b6f3c5754a970ab574d47.jpg`)
hexa.sendMessage(from, foto, image, {quoted : ftroli, thumbnail: thu, caption: `${help999}`, contextInfo: {mentionedJid: [sender], forwardingScore: 250, isForwarded: true,  externalAdReply: { title: 'Will-Awikwok', body: '𐎑⃢BY;🇮🇩Will🇮🇩☙', sourceUrl: `https://wa.me/c/6283870005811`, thumbnail: fakebis }}}) 
break
case 'tt':
